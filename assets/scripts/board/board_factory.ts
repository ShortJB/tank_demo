import { _decorator, Component, Node, NodePool, Vec3, instantiate, Prefab } from "cc";
...
export class boardFactory extends Component {
     ...
     * @returns Node
     */
    create_board(board_type: number, pos: Vec3, level: number) {
        ...
        node = pool.get(this, board_type, pos, level);
